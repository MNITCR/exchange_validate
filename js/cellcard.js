...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("cellCard-sim").addEventListener("click", function () {
        // Generate a random number
        const randomSimNumber = generateRandomNumber();

        // Set the generated number as the value of the input field
        const simNumber = document.getElementById("sim-cellCard-number").value = randomSimNumber;
    ...
    document.getElementById("cellCard-copy").addEventListener("click", function () {
        // Get the input field
        const inputField = document.getElementById("sim-cellCard-number");
    ...
    document.getElementById("cellCard-create-qr").addEventListener("click", function () {
        // Get the value entered in the input field
        const inputValue = document.getElementById("sim-cellCard-number").value;
        ...
        document.getElementById("qrcode-image-cellCard").src = qrCodeDataURL;

        // Store the QR code image element
        qrImage = document.getElementById("qrcode-image-cellCard");
    });

    // Click event handler for the "Download QR Code Image" button
    document.getElementById("cellCard-download-qr").addEventListener("click", function () {
        if (qrImage) {
